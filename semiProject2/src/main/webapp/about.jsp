...
<%@page import="com.semi2.review.model.ReviewService"%>
...
<%
    	int totalStore = (int)request.getAttribute("totalStore");
    	
    	int totalMem = (int)request.getAttribute("totalMem");
    	
    	int totalReview = (int)request.getAttribute("totalReview");
    	
    	int totalVisit = (int)request.getAttribute("totalVisit");
    %>
<!DOCTYPE html>
<html lang="ko">
