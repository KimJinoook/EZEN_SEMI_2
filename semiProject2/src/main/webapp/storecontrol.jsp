		...
		<script>
			$(function(){
				$('#searchBtn').click(function(){
					...
					location.href="storecontrol.do?keywordid="+key;
				});
				
				$('[id^=cstore]').on('click',function(){
					var stno = $(this).next('input').val();
					
						location.href="storeEdit.do?no="+stno;
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
            	...
            	<%}else{%>
                <h1 class="mb-4">맛집 목록</h1>
            		
            	<%}%>
            </div>
       		<div class="position-relative mx-auto" style="max-width: 400px;">
                <input class="form-control border-0 w-100 py-3 ps-4 pe-5" type="text" placeholder="맛집 검색" name="keywordid" id="keywordid">
	...
	<%}else{ %>
		...
		%>
			<div class="col-lg-4 col-md-6 portfolio-item first">
					<img class="img-fluid rounded-circle mx-auto mb-5" src="<%=vo.getPic()%>"  onerror="this.onerror=null; this.src='img/mem/user.png'" style="max-width: 150px;" id="cstore">
					<input type="hidden" value = "<%=vo.getNo()%>">
