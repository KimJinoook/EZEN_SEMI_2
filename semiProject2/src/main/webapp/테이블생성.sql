...
COMMENT ON TABLE s2_list IS '지역리스트';

COMMENT ON COLUMN s2_list.list_no IS '리스트번호';

COMMENT ON COLUMN s2_list.list_name IS '리스트이름';

COMMENT ON COLUMN s2_list.list_pic IS '지역사진';

COMMENT ON COLUMN s2_list.zip_seq IS '번호';
...
COMMENT ON TABLE s2_zipcode IS '주소정보';

COMMENT ON COLUMN s2_zipcode.zip_code IS '우편번호';

COMMENT ON COLUMN s2_zipcode.zip_si IS '시';

COMMENT ON COLUMN s2_zipcode.zip_gugun IS '구군';

COMMENT ON COLUMN s2_zipcode.zip_dong IS '동';

COMMENT ON COLUMN s2_zipcode.zip_sbunji IS '시작번지';

COMMENT ON COLUMN s2_zipcode.zip_ebunji IS '끝번지';

COMMENT ON COLUMN s2_zipcode.zip_seq IS '번호';
...
COMMENT ON TABLE s2_mem IS '회원정보';

COMMENT ON COLUMN s2_mem.mem_no IS '회원번호';

COMMENT ON COLUMN s2_mem.mem_name IS '이름';

COMMENT ON COLUMN s2_mem.mem_id IS 'ID';

COMMENT ON COLUMN s2_mem.mem_pw IS 'PW';

COMMENT ON COLUMN s2_mem.mem_birth IS '생년월일';

COMMENT ON COLUMN s2_mem.mem_tel IS '전화번호';

COMMENT ON COLUMN s2_mem.mem_add IS '주소';

COMMENT ON COLUMN s2_mem.mem_pic IS '프로필사진';
...
COMMENT ON TABLE s2_store IS '맛집';

COMMENT ON COLUMN s2_store.st_no IS '맛집번호';

COMMENT ON COLUMN s2_store.st_name IS '이름';

COMMENT ON COLUMN s2_store.st_add IS '주소';

COMMENT ON COLUMN s2_store.st_tel IS '전화번호';

COMMENT ON COLUMN s2_store.st_kind IS '음식종류';

COMMENT ON COLUMN s2_store.st_price IS '가격대';

COMMENT ON COLUMN s2_store.st_parking IS '주차';

COMMENT ON COLUMN s2_store.st_time IS '영업시간';

COMMENT ON COLUMN s2_store.st_restday IS '휴일';

COMMENT ON COLUMN s2_store.st_preview IS '식당소개';

COMMENT ON COLUMN s2_store.st_regdate IS '등록일';

COMMENT ON COLUMN s2_store.st_pic IS '맛집사진';

COMMENT ON COLUMN s2_store.list_no IS '리스트번호';
...
COMMENT ON TABLE s2_menu IS '메뉴';

COMMENT ON COLUMN s2_menu.st_no IS '맛집번호';

COMMENT ON COLUMN s2_menu.menu_name IS '메뉴이름';

COMMENT ON COLUMN s2_menu.menu_price IS '가격';

COMMENT ON COLUMN s2_menu.menu_pic IS '메뉴사진';
...
COMMENT ON TABLE s2_review IS '리뷰';

COMMENT ON COLUMN s2_review.re_no IS '리뷰번호';

COMMENT ON COLUMN s2_review.st_no IS '맛집번호';

COMMENT ON COLUMN s2_review.mem_no IS '회원번호';

COMMENT ON COLUMN s2_review.re_review IS '리뷰';

COMMENT ON COLUMN s2_review.re_score IS '평점';

COMMENT ON COLUMN s2_review.re_regdate IS '등록일';
...
COMMENT ON TABLE s2_coment IS '리뷰코멘트';

COMMENT ON COLUMN s2_coment.re_no IS '리뷰번호';

COMMENT ON COLUMN s2_coment.mem_no IS '회원번호';

COMMENT ON COLUMN s2_coment.co_coment IS '코멘트';

COMMENT ON COLUMN s2_coment.co_regdate IS '등록일';
