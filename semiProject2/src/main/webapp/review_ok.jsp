...
<%
	try{
		...
		//1
		String id=mr.getParameter("mem_id");
		String review=mr.getParameter("re_review");
		String regdate=mr.getParameter("re_regdate");
		
		Timestamp ts=Timestamp.valueOf(regdate);
