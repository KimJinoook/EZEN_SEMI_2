...
<script>
	$(function(){
		...
		$('#menuEdit').click(function(){
			window.open('menu_edit.jsp?st_no=<%=vo.getNo()%>','메뉴관리','width=600px, height=800px,scrollbars=yes');
		});
	});
</script>
                    ...
                    <div class="p-lg-5 pe-lg-0">
                        ...
                        <form method="post" action="storeEdit_ok.jsp" enctype="multipart/form-data" name="frmstoreadd">
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-6">
                                    <button class="btn btn-primary rounded-pill py-3 px-5" type="button" id="menuEdit">메뉴 관리</button>
                                </div>
                                <div class="col-12 col-sm-6">
