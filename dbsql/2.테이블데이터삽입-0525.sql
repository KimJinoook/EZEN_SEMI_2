...
insert into s2_menu
values (3,'두부젓국',25000,'3-4.jpg');
insert into s2_menu
values (3,'짜박두부',34000,'3-3.png');
insert into s2_menu
values (3,'냄비두부조림',28000,'3-3.png');
insert into s2_menu
values (3,'오모가리 청국장',25000,'3-4.jpg');
insert into s2_menu
...
insert into s2_menu
values (15,'제주 먹고기',13000,'15-3.JPG');
insert into s2_menu
